...
CREATE INDEX IF NOT EXISTS idx_sessions_user_id ON sessions(user_profile_id);
...
CREATE INDEX IF NOT EXISTS idx_module_progress_user_id ON module_progress(user_profile_id);
