...
record SpacedRepetitionItemResponse(String id, String userId, String unitReference, String moduleName,
                                    String level, int unitIndex, String nextReviewDate, int intervalIndex,
                                    int reviewCount, boolean graduated) {
