...
public final class PhonemeDailyAssignment extends AggregateRoot<PhonemeDailyAssignmentId> {
    ...
    private PhonemeDailyAssignment(PhonemeDailyAssignmentId id, UserProfileId userId, PhonemeId phonemeId,
                                    LocalDate assignedDate, boolean completed, Instant completedAt) {
        this.id = id;
        this.userId = userId;
    ...
    public static PhonemeDailyAssignment create(UserProfileId userId, PhonemeId phonemeId, LocalDate assignedDate) {
        return new PhonemeDailyAssignment(PhonemeDailyAssignmentId.generate(), userId, phonemeId,
                assignedDate, false, null);
    }
